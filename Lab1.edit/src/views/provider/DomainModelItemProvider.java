...
/**
 * This is the item provider adapter for a {@link views.DomainModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainModelItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ViewsPackage.Literals.DOMAIN_MODEL__NAMEDTYPES);
			childrenFeatures.add(ViewsPackage.Literals.DOMAIN_MODEL__CLASSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.DOMAIN_MODEL__NAMEDTYPES,
				 ViewsFactory.eINSTANCE.createDataType()));

		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.DOMAIN_MODEL__NAMEDTYPES,
				 ViewsFactory.eINSTANCE.createEnumerationType()));

		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.DOMAIN_MODEL__CLASSES,
