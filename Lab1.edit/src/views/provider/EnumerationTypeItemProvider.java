...
/**
 * This is the item provider adapter for a {@link views.EnumerationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationTypeItemProvider extends NamedTypeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ViewsPackage.Literals.ENUMERATION_TYPE__LITERAL);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EnumerationType.class)) {
			case ViewsPackage.ENUMERATION_TYPE__LITERAL:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.ENUMERATION_TYPE__LITERAL,
				 ViewsFactory.eINSTANCE.createLiteral()));
	}
