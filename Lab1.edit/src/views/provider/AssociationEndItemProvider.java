...
/**
 * This is the item provider adapter for a {@link views.AssociationEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AssociationEnd_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AssociationEnd_name_feature", "_UI_AssociationEnd_type"),
				 ViewsPackage.Literals.ASSOCIATION_END__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ViewsPackage.Literals.ASSOCIATION_END__LOWER_BOUND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ViewsPackage.Literals.ASSOCIATION_END__UPPER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AssociationEnd_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AssociationEnd_type_feature", "_UI_AssociationEnd_type"),
				 ViewsPackage.Literals.ASSOCIATION_END__TYPE,
				 true,
				 false,
				 true,
				 null,
