...
public class ViewsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ViewsPackage.NAVIGABLE_ASSOCIATION_END: {
				NavigableAssociationEnd navigableAssociationEnd = (NavigableAssociationEnd)theEObject;
				T result = caseNavigableAssociationEnd(navigableAssociationEnd);
				if (result == null) result = caseAssociationEnd(navigableAssociationEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewsPackage.NON_NAVIGABLE_ASSOCIATION_END: {
				NonNavigableAssociationEnd nonNavigableAssociationEnd = (NonNavigableAssociationEnd)theEObject;
				T result = caseNonNavigableAssociationEnd(nonNavigableAssociationEnd);
				if (result == null) result = caseAssociationEnd(nonNavigableAssociationEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ViewsPackage.ENUMERATION_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Navigable Association End</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Navigable Association End</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNavigableAssociationEnd(NavigableAssociationEnd object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Non Navigable Association End</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Non Navigable Association End</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNonNavigableAssociationEnd(NonNavigableAssociationEnd object) {
		return null;
	}
