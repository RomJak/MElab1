 ...
 * </p>
 * <ul>
 *   <li>{@link views.impl.EnumerationTypeImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationTypeImpl extends NamedTypeImpl implements EnumerationType {
	/**
	...
	protected EClass eStaticClass() {
		return ViewsPackage.Literals.ENUMERATION_TYPE;
	}
	...
	public EList<Literal> getLiteral() {
		if (literal == null) {
			literal = new EObjectContainmentEList<Literal>(Literal.class, this, ViewsPackage.ENUMERATION_TYPE__LITERAL);
		}
		return literal;
	}
