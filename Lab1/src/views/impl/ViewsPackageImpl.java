...
public class ViewsPackageImpl extends EPackageImpl implements ViewsPackage {
	 ...
	 * @generated
	 */
	private EClass navigableAssociationEndEClass = null;
	 ...
	 * @generated
	 */
	private EClass nonNavigableAssociationEndEClass = null;
	 ...
	 * @generated
	 */
	public EReference getDomainModel_Namedtypes() {
	 ...
	 * @generated
	 */
	public EClass getNavigableAssociationEnd() {
		return navigableAssociationEndEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getNonNavigableAssociationEnd() {
		return nonNavigableAssociationEndEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getNonNavigableAssociationEnd_PartOf() {
		return (EAttribute)nonNavigableAssociationEndEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getAssociation_Nonnavigableassociationend() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_Navigableassociationend() {
	...
	public void createPackageContents() {
		...
		createEReference(domainModelEClass, DOMAIN_MODEL__NAMEDTYPES);
		...
		navigableAssociationEndEClass = createEClass(NAVIGABLE_ASSOCIATION_END);

		nonNavigableAssociationEndEClass = createEClass(NON_NAVIGABLE_ASSOCIATION_END);
		createEAttribute(nonNavigableAssociationEndEClass, NON_NAVIGABLE_ASSOCIATION_END__PART_OF);

		associationEClass = createEClass(ASSOCIATION);
		createEAttribute(associationEClass, ASSOCIATION__NAME);
		createEReference(associationEClass, ASSOCIATION__NONNAVIGABLEASSOCIATIONEND);
		createEReference(associationEClass, ASSOCIATION__NAVIGABLEASSOCIATIONEND);
	...
	public void initializePackageContents() {
		...
		navigableAssociationEndEClass.getESuperTypes().add(this.getAssociationEnd());
		nonNavigableAssociationEndEClass.getESuperTypes().add(this.getAssociationEnd());
		dataTypeEClass.getESuperTypes().add(this.getNamedType());
		enumerationTypeEClass.getESuperTypes().add(this.getNamedType());
		...
		initEAttribute(getClass_Name(), ecorePackage.getEString(), "name", null, 0, 1, views.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProperty_Type(), this.getNamedType(), null, "type", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDomainModel_Namedtypes(), this.getNamedType(), null, "namedtypes", null, 0, -1, DomainModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAssociationEnd_LowerBound(), ecorePackage.getEInt(), "lowerBound", null, 0, 1, AssociationEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAssociationEnd_UpperBound(), ecorePackage.getEInt(), "upperBound", null, 0, 1, AssociationEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAssociationEnd_Type(), this.getClass_(), null, "type", null, 1, 1, AssociationEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(navigableAssociationEndEClass, NavigableAssociationEnd.class, "NavigableAssociationEnd", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(nonNavigableAssociationEndEClass, NonNavigableAssociationEnd.class, "NonNavigableAssociationEnd", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNonNavigableAssociationEnd_PartOf(), ecorePackage.getEBoolean(), "partOf", null, 0, 1, NonNavigableAssociationEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAssociation_Nonnavigableassociationend(), this.getNonNavigableAssociationEnd(), null, "nonnavigableassociationend", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAssociation_Navigableassociationend(), this.getNavigableAssociationEnd(), null, "navigableassociationend", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEnumerationType_Literal(), this.getLiteral(), null, "literal", null, 1, -1, EnumerationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
